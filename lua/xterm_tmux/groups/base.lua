--Shamelessly copied from folke/tokyonight
local M = {}
...
function M.get(c, opts)
  ...
  return {
    ...
    EndOfBuffer                 = { fg = c.eof }, -- filler lines (~) after the end of the buffer.  By default, this is highlighted like |hl-NonText|.
    ...
    PmenuMatch                  = { bg = c.bg_popup, fg = c.fg_popup }, -- Popup menu: Matched text in normal item.
    PmenuSel                    = { bg = c.fg_gutter }, -- Popup menu: selected item.
    PmenuMatchSel               = { bg = c.fg_gutter, fg = c.bg_popup }, -- Popup menu: Matched text in selected item.
    ...
    TabLineSel                  = { fg = c.bg, bg = c.border_highlight}, -- tab pages line, active tab page label
    Title                       = { fg = c.border_highlight, bold = true }, -- titles for output from ":set all", ":autocmd" etc.
